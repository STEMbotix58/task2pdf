...
const AdminSidebar = ({ activeTab, setActiveTab }) => {
  const navItems = [
    ...
    { name: "Report V1", key: "flp_report", icon: <MdStoreMallDirectory /> },
    {
      name: "Report V2",
      key: "stemlab_report",
      icon: <FiFileText />,
    },
    { name: "Report V3", key: "projects", icon: <MdStoreMallDirectory /> },
    { name: "Report V4", key: "reports", icon: <FiBriefcase /> },
